...
class NUMPYIEKF:
    ...
    def propagate_cov(
        self, P_prev, Rot_prev, v_prev, p_prev, b_omega_prev, b_acc_prev, u, dt
    ):
    ...
    def set_learned_covariance(self, torch_iekf):
        ...
        beta = torch_iekf.initprocesscov_net.init_cov(torch_iekf).detach().cpu().numpy()
